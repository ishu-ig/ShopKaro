    ...
    return (
        <>
            <div className="container-fluid">
                {/* Header */}
                <h5 className="text-center text-light bg-primary p-3">Brand <Link to="/brand/create"><i className="fa fa-plus text-light float-end pt-1"></i></Link></h5>
                {/* Table */}
                        ...
                        <tbody>
                            {
                                BrandStateData.map((item) => {
                                    return <tr key={item._id}>
                                        ...
                                        <td><Link to={`/brand/update/${item._id}`} className='btn btn-primary text-light'><i className='fa fa-edit fs-4'></i></Link></td>
