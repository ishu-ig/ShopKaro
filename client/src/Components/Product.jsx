        ...
        <>
            <div className="container-fluid py-5 bg-light">
                <div className="container">
                    {/* Section Title */}
                    {title !== "Shop" && (
                        <div className="text-center mx-auto pb-5 wow animate__animated animate__fadeIn" data-wow-delay=".3s" style={{ maxWidth: "600px" }}>
                    ...
                    <div className="row g-4">
                        {data.slice(0, visibleCount).map((item) => (
                            <div key={item?._id} className="col-md-6 col-lg-4 wow animate__animated animate__zoomIn" data-wow-delay=".3s">
                                <div className="product-card position-relative overflow-hidden shadow-lg rounded">
                                    ...
                                    {/* Hover Effect */}
                                    <div className="product-content position-absolute w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center">
                    ...
                    {title !== "Shop" && (
                        <div className="row">
                            <Link to={`/shop?mc=${title}`} className="mx-auto btn btn-dark text-white px-5 py-3 w-25 mt-4 rounded-pill shadow-sm fw-bold">
                                View More
                            </Link>
                        </div>
                    )}
